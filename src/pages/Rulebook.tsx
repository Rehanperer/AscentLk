...
• 1.1. Player Age Requirements: The tournament is open to players of all ages. Participants under the age of 18 must secure verifiable parent or legal guardian consent before registering.
                    ...
                    <SectionReveal>
                        ...
                        <div className="space-y-12 text-lg leading-relaxed print:text-black print:bg-white print:p-8">
                            ...
                            <section className="border-l-2 border-[#ff4655]/40 pl-6">
                                ...
                                <ul className="list-none space-y-4 text-white/60 text-base md:text-lg">
                                    <li><strong className="text-white">1.1. Player Age Requirements:</strong> The tournament is open to players of all ages. Participants under the age of 18 must secure verifiable parent or legal guardian consent before registering.</li>
